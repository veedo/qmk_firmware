...
#define HEATMAP_NUM_COLOURS (16)
 static const uint8_t heatmap_led_colours[HEATMAP_NUM_COLOURS][3] = {
     {0,255,255}, {14,255,255}, {28,255,255}, {42,255,255},
     {56,255,255}, {70,255,255}, {84,255,255}, {98,255,255},
     {112,255,255}, {126,255,255}, {140,255,255}, {154,255,255},
     {168,255,255}, {182,255,255}, {196,255,255}, {210,255,255},
 };
...
void clear_heatmap_led_at(uint8_t offset) {
    ...
    layer_base_lights[14+offset] = (rgblight_segment_t)RGBLIGHT_END_SEGMENTS;
